...
namespace soildworks
{
    /// <summary>
    /// Summary description for soildworks.
    /// </summary>
    [Guid("d5d5e6e7-8cb0-457c-95df-692002332e21"), ComVisible(true)]
    [SwAddin(
        Description = "soildworks description",
        Title = "soildworkspppp",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("soildworks.ToolbarLarge.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("soildworks.ToolbarSmall.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("soildworks.MainIconLarge.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("soildworks.MainIconSmall.bmp", thisAssembly);
