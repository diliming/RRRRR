...
namespace SwCSharpAddin10
{
    /// <summary>
    /// Summary description for SwCSharpAddin10.
    /// </summary>
    [Guid("8da7a250-af86-4664-8ee0-f4b95e218eca"), ComVisible(true)]
    [SwAddin(
        Description = "SwCSharpAddin10 description",
        Title = "SwCSharpAddinqwerdprrr9",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            string Title = "C# Addin", ToolTip = "C# Addine";
            ...
            cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin10.ToolbarLarge.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin10.ToolbarSmall.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin10.MainIconLarge.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("SwCSharpAddin10.MainIconSmall.bmp", thisAssembly);
